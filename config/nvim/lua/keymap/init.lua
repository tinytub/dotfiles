...
local plug_map = {
    ...
    --["i|<TAB>"]      = map_cmd('v:lua.MUtils.tab()'):with_expr():with_silent(),
    --["i|<S-TAB>"]    = map_cmd('v:lua.MUtils.s_tab()'):with_silent():with_expr(),
--    ["i|<CR>"]       = map_cmd([[compe#confirm({ 'keys': "\<Plug>delimitMateCR", 'mode': '' })]]):with_noremap():with_expr():with_nowait(),
    ...
    ["i|<CR>"]       = map_cmd('v:lua.MUtils.completion_confirm()'):with_expr(),
    -- person keymap
...
--    ["n|<leader>lr"]     = map_cr("LspRestart"):with_noremap():with_silent():with_nowait(),
   ...
   -- smoothie
    ["n|<C-f>"]          = map_cmd(":<C-U>call smoothie#forwards()<CR>"):with_silent():with_noremap():with_nowait(),
    ["n|<C-b>"]          = map_cmd(":<C-U>call smoothie#backwards()<CR>"):with_silent():with_noremap():with_nowait(),
    ["n|<C-d>"]          = map_cmd(":<C-U>call smoothie#downwards()<CR>"):with_silent():with_noremap():with_nowait(),
    ["n|<C-u>"]          = map_cmd(":<C-U>call smoothie#upwards()<CR>"):with_silent():with_noremap():with_nowait(),
...
--    ["n|<eader>fa"]     = map_cu('Telescope live_grep'):with_noremap():with_silent(),
